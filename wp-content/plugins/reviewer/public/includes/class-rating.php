...
class RWP_Rating
{
	...
	public function localize_script()
	{
		...
		wp_localize_script( $this->plugin_slug . '-reviews-boxes-script', 'reviewerRatingObj', array('ajax_nonce' => wp_create_nonce( $action_name ), 'ajax_url' => admin_url('admin-ajax.php'), 'action' => $action_name ) );
