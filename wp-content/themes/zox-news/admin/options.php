...
$options[] = array( "name" => esc_html__('Toggle Megamenus','zox-news'),
			"desc" => "Toggle on/off the Megamenu feature for Category menu items",
			"id" => $shortname."_megamenu",
			"class" => "medium first",
			"std" => "true",
			"type" => "switch");
...
$options[] = array( "name" => esc_html__('Show Featured Posts?','zox-news'),
	...
	$options[] = array( "name" => esc_html__("Featured Posts Content","zox-news"),
				"desc" => esc_html__("Select whether to display latest posts or display posts by a specific Tag.","zox-news"),
...
$options[] = array( "name" => esc_html__('Article Inline Ad Code','zox-news'),
			"desc" => "Enter your ad code (Eg. Google Adsense, Taboola, HTML, or Javascript) for the article ad(s) within the body of articles.",
			"id" => $shortname."_post_inad",
			"class" => "medium first",
			"std" => "",
			"type" => "textarea");

$options[] = array( "name" => esc_html__("Insert Ad Every X Paragraphs","zoxpress"),
			"desc" => esc_html__("Set the frequency that the article ads will appear. For example, if you set the number to 4, there will be an ad inserted after every 4th paragraph.","zox-news"),
			"id" => $shortname."_post_freq",
			"class" => "medium last",
			"std" => 5,
			"min" => 2,
			"max" => 20,
...
$options[] = array( "name" => esc_html__('Article Bottom Ad Code','zox-news'),
			"desc" => "Enter your ad code (Eg. Google Adsense, Taboola, HTML, or Javascript) for the ad area below the article. The maximum width of this area is 740px, but it can be any height.",
...
$options[] = array( "name" => esc_html__('TikTok','zox-news'),
			"desc" => "Enter your TikTok URL here.",
...
/*	Back-up & Reset
	...
	$options[] = array( "name" => __('Back-up & Reset','zoxpress'),
						"type" => "section");
	
	// Backup Field					
	$options[] = array( "name" => __("Backup Theme Options","zoxpress"),
				"desc" => __("Create a backup for your current Theme Options. You can then restore the Theme Options with this save at a later date.", "zoxpress"),
				"id" => $shortname."_backup",
				"class" => "medium first",
				"type" => "backup");
	
	// Reset					
	$options[] = array( "name" => __("Reset Theme Options","zoxpress"),
				"desc" => __("Reset your Theme Options to the original settings when you first installed the theme. This will delete any changes you made to the Theme Options since installing the theme.", "zoxpress"),
				"class" => "medium last",
				"type" => "reset");	
