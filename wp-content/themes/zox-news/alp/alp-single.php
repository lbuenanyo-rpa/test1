							...
							<div class="mvp-author-info-wrap left relative">
								...
								<div class="mvp-author-info-text left relative">
									...
									<div class="mvp-author-info-name left relative" itemprop="author" itemscope itemtype="https://schema.org/Person">
										<p><?php esc_html_e( 'By', 'zox-news' ); ?></p> <span class="author-name vcard fn author" itemprop="name"><?php the_author_posts_link(); ?></span> <?php $authortwit = get_the_author_meta('twitter'); if ( ! empty ( $authortwit ) ) { ?><a href="<?php echo esc_url(the_author_meta('twitter')); ?>" class="mvp-twit-but" target="_blank"><span class="mvp-author-info-twit-but"><i class="fab fa-twitter"></i></span></a><?php } ?>
																		...
																		<div id="mvp-author-box-head" class="left relative">
																			...
																			<div id="mvp-author-box-soc-wrap" class="left relative">
																				<?php $mvp_email = get_option('mvp_author_email'); if ($mvp_email == "true") { ?>
																					<a href="mailto:<?php the_author_meta('email'); ?>"><span class="mvp-author-box-soc fas fa-envelope"></span></a>
																				<?php } ?>
