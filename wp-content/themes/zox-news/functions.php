...
$font_url = '';
    ...
    if ( 'off' !== _x( 'on', 'Google font: on or off', 'zox-news' ) ) {
        $font_url = add_query_arg( 'family', urlencode( 'Roboto:300,400,700,900|Oswald:400,700|Advent Pro:700|Open Sans:700|Anton:400' .  $mvp_featured_font . ':100,200,300,400,500,600,700,800,900|' .  $mvp_title_font . ':100,200,300,400,500,600,700,800,900|' .  $mvp_heading_font . ':100,200,300,400,500,600,700,800,900|' .  $mvp_content_font . ':100,200,300,400,500,600,700,800,900|' .  $mvp_para_font . ':100,200,300,400,500,600,700,800,900|' .  $mvp_menu_font . ':100,200,300,400,500,600,700,800,900&subset=latin,latin-ext,cyrillic,cyrillic-ext,greek-ext,greek,vietnamese&display=swap' ), "//fonts.googleapis.com/css" );
    }
    return $font_url;
}
}
...
function register_menus() {
	register_nav_menus(
		array(
			...
			'amp-menu' => esc_html__( 'Fly-Out AMP Menu', 'zox-news' ),
			'footer-menu' => esc_html__( 'Footer Menu', 'zox-news' ),
			'main2-menu' => esc_html__('Main menu 2', 'zox-news'))
	  	);
	  }
}
...
add_action('amp_post_template_head','mvp_amp_google_font');
 ...
 ?>
 <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Advent Pro:700|Open Sans:700|<?php echo $mvp_amp_featured_font; ?>:100,200,300,400,500,600,700,800,900|<?php echo $mvp_amp_title_font; ?>:100,200,300,400,500,600,700,800,900|<?php echo $mvp_amp_heading_font; ?>:100,200,300,400,500,600,700,800,900|<?php echo $mvp_amp_content_font; ?>:100,200,300,400,500,600,700,800,900|<?php echo $mvp_amp_para_font; ?>:100,200,300,400,500,600,700,800,900|<?php echo $mvp_amp_menu_font; ?>:100,200,300,400,500,600,700,800,900&subset=arabic,latin,latin-ext,cyrillic,cyrillic-ext,greek-ext,greek,vietnamese&display=swap">
 <?php
 }
