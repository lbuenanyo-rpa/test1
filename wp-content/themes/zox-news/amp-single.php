...
<head>
	...
	<!-- <link rel="amphtml" href="<?php echo get_permalink(); ?>" /> -->
	...
	<?php if (have_posts()):
		while (have_posts()):
			...
			<?php if ((function_exists('has_post_thumbnail')) && (has_post_thumbnail())) { ?>
				<?php global $post;
				$thumb = wp_get_attachment_image_src(get_post_thumbnail_id($post->ID), 'mvp-post-thumb'); ?>
		...
		<div id="mvp-site-wall" class="left relative">
			<div id="mvp-site-main" class="left relative">
									...
									<div id="mvp-nav-small-wrap">
										<div class="mvp-nav-small-cont">
											<div id="mvp-nav-small-left">
												<div class="mvp-fly-but-wrap left relative ampstart-btn caps m2"
													on="tap:sidebar.toggle" role="button" tabindex="0">
													<span></span>
													<span></span>
													<span></span>
													<span></span>
											...
											<div class="mvp-nav-small-mid">
												<div class="mvp-nav-small-logo">
													<?php if (get_option('mvp_logo_nav')) { ?>
														<a href="<?php echo esc_url(home_url('/')); ?>"><amp-img
																src="<?php echo esc_url(get_option('mvp_logo_nav')); ?>"
																alt="<?php bloginfo('name'); ?>" data-rjs="2"
																width="<?php echo esc_html(get_option('mvp_amp_logo')); ?>"
																height="30" layout="fixed"></amp-img></a>
													<?php } else { ?>
														<a href="<?php echo esc_url(home_url('/')); ?>"><amp-img
					...
					<div id="mvp-soc-mob-wrap" class="left relative">
						<div class="mvp-main-box">
							<div class="mvp-soc-mob-cont">
								<amp-social-share class="rounded" type="email" width="36"
									height="36"></amp-social-share>
								<?php $mvp_amp_fb = get_option('mvp_amp_fb');
								if ($mvp_amp_fb) { ?>
									<amp-social-share class="rounded" type="facebook" width="36" height="36"
										data-param-app_id="<?php echo esc_html($mvp_amp_fb); ?>"></amp-social-share>
								<?php } ?>
								<amp-social-share class="rounded" type="twitter" width="36"
									height="36"></amp-social-share>
								<amp-social-share class="rounded" type="pinterest" data-param-media="<?php $thumb = wp_get_attachment_image_src(get_post_thumbnail_id($post->ID), 'mvp-post-thumb');
								echo esc_url($thumb['0']); ?>" width="36" height="36"></amp-social-share>
								<amp-social-share class="rounded" type="whatsapp" width="36"
									height="36"></amp-social-share>
				...
				<amp-sticky-ad layout="nodisplay">
					<amp-ad width="320" height="100" type="doubleclick" data-slot="/78858240/DiarioQue_amp/sticky">
					</amp-ad>
				</amp-sticky-ad>
				<!-- PUBLICIDAD -->
				<div id="mvp-main-body-wrap" class="left relative">
					...
					<div class="mvp-widget-feat2-side-ad relative">
						...
						<div class="table m-auto px-2 pb-2 bg-white text-center border border-grey-100 text-xs publicidad-span"
							style="">
							<amp-ad width=300 height=250 type="doubleclick" data-slot="/78858240/DiarioQue_amp/header"
													...
													<div class="mvp-author-info-wrap left relative">
														<div class="mvp-author-info-thumb left relative">
															<amp-img
																...
																width="46" height="46" layout="responsive"></amp-img>
														</div><!--mvp-author-info-thumb-->
														<div class="mvp-author-info-text left relative">
															<div class="mvp-author-info-date left relative">
																<p>
																	<?php esc_html_e('Published', 'zox-news'); ?>
																</p> <span class="mvp-post-date">
																	<?php printf(esc_html__('%s ago', 'zox-news'), human_time_diff(get_the_time('U'), current_time('timestamp'))); ?>
																</span>
																<p>
																	<?php esc_html_e('on', 'zox-news'); ?>
																...
																<meta itemprop="dateModified"
																	content="<?php the_modified_date('Y-m-d g:i a'); ?>" />
															</div><!--mvp-author-info-date-->
															<div class="mvp-author-info-name left relative" itemprop="author"
																itemscope itemtype="https://schema.org/Person">
																<p>
																	<?php esc_html_e('By', 'zox-news'); ?>
																</p> <span class="author-name vcard fn author" itemprop="name">
																	<?php the_author_posts_link(); ?>
																</span>
																<?php $authortwit = get_the_author_meta('twitter');
																if (!empty($authortwit)) { ?><a href="<?php echo esc_url(the_author_meta('twitter')); ?>"
														...
														<?php } else { ?>
															<?php if ((function_exists('has_post_thumbnail')) && (has_post_thumbnail())) { ?>
																<div id="mvp-post-feat-img" class="left relative mvp-post-feat-img-wide2"
																	...
																	$mvp_thumb_width = $mvp_thumb_array[1];
																	$mvp_thumb_height = $mvp_thumb_array[2]; ?>
																	<amp-img src="<?php echo esc_url($mvp_thumb_url) ?>"
																		width="<?php echo esc_html($mvp_thumb_width) ?>"
																		height="<?php echo esc_html($mvp_thumb_height) ?>"
												...
												<div class="mvp-widget-feat2-side-ad relative">
													...
													<div class="table m-auto px-2 pb-2 bg-white text-center border border-grey-100 text-xs publicidad-span"
														...
														<amp-ad width=300 height=250 type="doubleclick"
															data-slot="/78858240/DiarioQue_amp/top" data-multi-size="300x250">
														</amp-ad>
													</div>
												</div>
												<!-- PUBLICIDAD -->
															...
															<div id="mvp-content-bot" class="left">
																<div class="mvp-post-tags">
																	<span class="mvp-post-tags-header">
																		<?php esc_html_e('Related Topics:', 'zox-news'); ?>
																	...
																	<div class="mvp-org-logo" itemprop="logo" itemscope
																		...
																		<?php if (get_option('mvp_logo_nav')) { ?>
																			<amp-img
																				...
																				alt="<?php bloginfo('name'); ?>" data-rjs="2"
																				width="<?php echo esc_html(get_option('mvp_amp_logo')); ?>"
																				height="30" layout="fixed"></amp-img>
																			<meta itemprop="url"
																				content="<?php echo esc_url(get_option('mvp_logo_nav')); ?>">
																		<?php } else { ?>
																			<amp-img
																				src="<?php echo get_template_directory_uri(); ?>/images/logos/logo-nav.png"
																				alt="<?php bloginfo('name'); ?>" data-rjs="2"
																...
																<div class="mvp-widget-feat2-side-ad relative">
																	...
																	<div class="table m-auto px-2 pb-2 bg-white text-center border border-grey-100 text-xs publicidad-span"
																		style="">
																		<amp-ad width=300 height=250 type="doubleclick"
																			data-slot="/78858240/DiarioQue_amp/middle4"
																			data-multi-size="300x250">
																		</amp-ad>
																	</div>
																</div>
										...
										if ($mvp_trend_posts == "true") { ?>
											<div id="mvp-post-more-wrap" class="left relative">
												...
												<ul class="mvp-post-more-list left relative">
													...
													$recent = new WP_Query(array('posts_per_page' => '6', 'ignore_sticky_posts' => 1, 'post__not_in' => array($post->ID), 'orderby' => 'meta_value_num', 'order' => 'DESC', 'meta_key' => 'post_views_count', 'date_query' => array(array('after' => $popular_days_ago))));
															...
															<?php if ((function_exists('has_post_thumbnail')) && (has_post_thumbnail())) { ?>
																<div class="mvp-post-more-img left relative">
																	<a href="<?php the_permalink(); ?>" rel="bookmark">
																		<?php $thumb_id = get_post_thumbnail_id();
																		$mvp_thumb_array = wp_get_attachment_image_src($thumb_id, 'mvp-mid-thumb', true);
																		$mvp_thumb_url = $mvp_thumb_array[0];
																		$mvp_thumb_width = $mvp_thumb_array[1];
																		$mvp_thumb_height = $mvp_thumb_array[2]; ?>
																		<amp-img class="mvp-reg-img"
																			src="<?php echo esc_url($mvp_thumb_url) ?>"
																			width="<?php echo esc_html($mvp_thumb_width) ?>"
																			height="<?php echo esc_html($mvp_thumb_height) ?>"
																			layout="responsive"></amp-img>
																		<?php $thumb_id = get_post_thumbnail_id();
																		$mvp_thumb_array = wp_get_attachment_image_src($thumb_id, 'mvp-small-thumb', true);
																		$mvp_thumb_url = $mvp_thumb_array[0];
																		$mvp_thumb_width = $mvp_thumb_array[1];
																		$mvp_thumb_height = $mvp_thumb_array[2]; ?>
																		<amp-img class="mvp-mob-img"
																			src="<?php echo esc_url($mvp_thumb_url) ?>"
																			width="<?php echo esc_html($mvp_thumb_width) ?>"
																			height="<?php echo esc_html($mvp_thumb_height) ?>"
																			layout="responsive"></amp-img>
					...
					<div id="mvp-foot-bot" class="left relative">
						<div class="mvp-main-box">
							<div id="mvp-foot-copy" class="left relative">
								<p>
									<?php echo wp_kses_post(get_option('mvp_copyright')); ?>
								</p>
							</div><!--mvp-foot-copy-->
						</div><!--mvp-main-box-->
					</div><!--mvp-foot-bot-->
