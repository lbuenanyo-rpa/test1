<?php $mvp_feat_layout = get_option('mvp_feat_layout');
if ($mvp_feat_layout == "0") { ?>
		...
		<section id="mvp-feat1-wrap" class="left relative">
			<div class="mvp-feat1-right-out left relative">
				<div class="mvp-feat1-right-in">
					<div class="mvp-feat1-main left relative">
						<div class="mvp-feat1-left-wrap relative">
							...
							global $post;
							$recent = new WP_Query(array('tag' => get_option('mvp_feat_posts_tags'), 'posts_per_page' => '1', 'ignore_sticky_posts' => 1));
									...
									<div class="mvp-feat1-feat-wrap left relative">
										...
										<div class="mvp-feat1-feat-text left relative">
											...
											<?php if (get_post_meta($post->ID, "mvp_featured_headline", true)): ?>
												<h2>
													<?php echo esc_html(get_post_meta($post->ID, "mvp_featured_headline", true)); ?>
												</h2>
											<?php else: ?>
							...
							<div class="mvp-feat1-sub-wrap left relative">
								<?php global $do_not_duplicate;
								global $post;
								$recent = new WP_Query(array('tag' => get_option('mvp_feat_posts_tags'), 'post__not_in' => $do_not_duplicate, 'posts_per_page' => '2', 'ignore_sticky_posts' => 1));
								while ($recent->have_posts()):
									$recent->the_post();
									$do_not_duplicate[] = $post->ID; ?>
									<a href="<?php the_permalink(); ?>" rel="bookmark">
						...
						<div class="mvp-feat1-mid-wrap left relative">
							...
							<div class="mvp-feat1-pop-wrap left relative">
								...
								// Nueva query para filtrar ultimas 24 horas
								$argumentos = [
									'post_type' => 'post',
									'posts_per_page' => 5,
									'date_query' => array(
								...
								//$popular_items =new WordPressPopularPosts\Query($argumentos);
								$popular_items = new WP_Query($argumentos);
								foreach ($popular_items->get_posts() as $posts) {
									?>
									<a href="<?php echo get_permalink($posts->ID); ?>" rel="bookmark">
										<div class="mvp-feat1-pop-cont left relative">
											<?php if ((function_exists('has_post_thumbnail'))) { ?>
												<div class="mvp-feat1-pop-img left relative">
													<?php echo get_the_post_thumbnail($posts->ID, $size = 'mvp-mid-thumb', $attr = 'mvp-reg-img') ?>
													<?php if (get_post_format($posts->ID) === 'video') { ?>
														<div class="mvp-vid-box-wrap mvp-vid-box-mid mvp-vid-marg">
															<i class="fa fa-2 fa-play" aria-hidden="true"></i>
														</div><!--mvp-vid-box-wrap-->
													<?php } else if (get_post_format($posts->ID) === 'gallery') { ?>
											...
											<div class="mvp-feat1-pop-text left relative">
												<div class="mvp-cat-date-wrap left relative">
													<span class="mvp-cd-cat left relative">
														...
														<?php printf(esc_html__('hace %s', 'zox-news'), human_time_diff(get_the_time('U', $posts->ID), current_time('timestamp'))); ?>
													</span>
												</div><!--mvp-cat-date-wrap-->
												<h2>
				...
				<div class="mvp-feat1-right-wrap left relative">
					<?php
					$link_acortada = get_option('acortada_url_featured');
					$image_url_mobile = get_option('image_url_mobile_featured');
					...
					<?php if (get_option('mvp_feat_ad')) { ?>
						<div class="mvp-feat1-list-ad left relative">
							...
							<?php $mvp_feat_ad = get_option('mvp_feat_ad');
							if ($mvp_feat_ad) {
								echo do_shortcode(html_entity_decode($mvp_feat_ad));
							} ?>
						</div><!--mvp-feat1-list-ad-->
					<?php } ?>
					<div class="mvp-feat1-list-wrap left relative">
						<div class="mvp-feat1-list-head-wrap left relative">
							<h3 class="mvp-feat1-pop-head"><span class="mvp-feat1-pop-head"> <?php esc_html_e('Lo último', 'zox-news'); ?>
							</span></h3>
						</div><!--mvp-feat1-list-head-wrap-->
						<div id="mvp-feat-tab-col1" class="mvp-feat1-list left relative mvp-tab-col-cont">
							<?php /* global $do_not_duplicate;
							if (isset($do_not_duplicate)) {
								if (get_option('mvp_feat_ad')) {
									$mvp_feat_list_num = 8;
								} else {
									$mvp_feat_list_num = 8;
								}
								...
								query_posts(array('posts_per_page' => $mvp_feat_list_num, 'post__not_in' => $do_not_duplicate, 'paged' => $paged, 'ignore_sticky_posts' => 1));
								if (have_posts()):
									while (have_posts()):
										the_post(); ?>
										<a href="<?php the_permalink(); ?>" rel="bookmark">
						...
						<div id="mvp-feat-tab-col2" class="mvp-feat1-list left relative mvp-tab-col-cont">
							...
							if (isset($do_not_duplicate)) {
								if (get_option('mvp_feat_ad')) {
									$mvp_feat_list_num = 10;
								} else {
									$mvp_feat_list_num = 13;
								}
								;
								$paged = (get_query_var('page')) ? get_query_var('page') : 1;
								query_posts(array('tax_query' => array(array('taxonomy' => 'post_format', 'field' => 'slug', 'terms' => 'post-format-video')), 'posts_per_page' => $mvp_feat_list_num, 'ignore_sticky_posts' => 1, 'post__not_in' => $do_not_duplicate, 'paged' => $paged));
								if (have_posts()):
									while (have_posts()):
										the_post(); ?>
										<a href="<?php the_permalink(); ?>" rel="bookmark">
						...
						<div id="mvp-feat-tab-col3" class="mvp-feat1-list left relative mvp-tab-col-cont">
							...
							if (isset($do_not_duplicate)) {
								...
								;
								$paged = (get_query_var('page')) ? get_query_var('page') : 1;
								query_posts(array('tax_query' => array(array('taxonomy' => 'post_format', 'field' => 'slug', 'terms' => 'post-format-gallery')), 'posts_per_page' => $mvp_feat_list_num, 'ignore_sticky_posts' => 1, 'post__not_in' => $do_not_duplicate, 'paged' => $paged));
								if (have_posts()):
									while (have_posts()):
										the_post(); ?>
										<a href="<?php the_permalink(); ?>" rel="bookmark">
		...
		<section id="mvp-feat2-wrap" class="left relative">
			...
			<div class="mvp-feat2-bot-wrap left relative">
				<div class="mvp-main-box">
					...
					<?php global $do_not_duplicate;
					global $post;
					$recent = new WP_Query(array('tag' => get_option('mvp_feat_posts_tags'), 'post__not_in' => $do_not_duplicate, 'posts_per_page' => '4', 'ignore_sticky_posts' => 1));
					while ($recent->have_posts()):
						$recent->the_post();
						$do_not_duplicate[] = $post->ID; ?>
							<a href="<?php the_permalink(); ?>" rel="bookmark">
...
<?php } else if ($mvp_feat_layout == "4") { ?>
					<div class="mvp-main-box">
						<section id="mvp-feat5-wrap" class="left relative">
							...
							wp_reset_postdata(); ?>
								...
								<?php global $do_not_duplicate;
								global $post;
								$recent = new WP_Query(array('tag' => get_option('mvp_feat_posts_tags'), 'post__not_in' => $do_not_duplicate, 'posts_per_page' => '3', 'ignore_sticky_posts' => 1));
								while ($recent->have_posts()):
									$recent->the_post();
									$do_not_duplicate[] = $post->ID; ?>
													<a href="<?php the_permalink(); ?>" rel="bookmark">
								...
								wp_reset_postdata(); ?>
										...
										<div class="mvp-feat5-small-wrap left relative">
											<h3 class="mvp-feat1-pop-head"><span class="mvp-feat1-pop-head">
									<?php esc_html_e('Lo último', 'zox-news'); ?>
												</span></h3>
							<?php global $do_not_duplicate;
							if (isset($do_not_duplicate)) {
								$paged = (get_query_var('page')) ? get_query_var('page') : 1;
								query_posts(array('posts_per_page' => '1', 'post__not_in' => $do_not_duplicate, 'paged' => $paged, 'ignore_sticky_posts' => 1));
								if (have_posts()):
									while (have_posts()):
										the_post();
										$do_not_duplicate[] = $post->ID; ?>
								...
								if (isset($do_not_duplicate)) {
									$paged = (get_query_var('page')) ? get_query_var('page') : 1;
									query_posts(array('posts_per_page' => '6', 'post__not_in' => $do_not_duplicate, 'paged' => $paged, 'ignore_sticky_posts' => 1));
									if (have_posts()):
										while (have_posts()):
											the_post(); ?>
															<a href="<?php the_permalink(); ?>" rel="bookmark">
					...
					<?php } ?>
						...
						;
						$recent = new WP_Query(array('posts_per_page' => $mvp_feat_list_num, 'ignore_sticky_posts' => 1, 'post__not_in' => $do_not_duplicate, 'orderby' => 'meta_value_num', 'order' => 'DESC', 'meta_key' => 'post_views_count', 'date_query' => array(array('after' => $popular_days_ago))));
						while ($recent->have_posts()):
							$recent->the_post(); ?>
											<a href="<?php the_permalink(); ?>" rel="bookmark">
												<div class="mvp-feat1-list-cont left relative">
