...
class mvp_tabber_widget extends WP_Widget {
	...
	function form( $instance ) {
		...
		$defaults = array( 'number' => 5, 'popular_days' => 30, 'first' => 'Últimas', 'second' => 'popular', 'third' => 'video', 'first_title' => 'Últimas', 'second_title' => 'Popular', 'third_title' => 'Videos' );
		...
		<p>
			...
			<select id="<?php echo $this->get_field_id('first'); ?>" name="<?php echo $this->get_field_name('first'); ?>" style="width:100%;">
				<option value='Últimas' <?php if ('Últimas' == $instance['first']) echo 'selected="selected"'; ?>>Lo último</option>
		...
		<p>
			...
			<select id="<?php echo $this->get_field_id('second'); ?>" name="<?php echo $this->get_field_name('second'); ?>" style="width:100%;">
				<option value='Últimas' <?php if ('Últimas' == $instance['second']) echo 'selected="selected"'; ?>>Lo último</option>
		...
		<p>
			...
			<select id="<?php echo $this->get_field_id('third'); ?>" name="<?php echo $this->get_field_name('third'); ?>" style="width:100%;">
				<option value='Últimas' <?php if ('Últimas' == $instance['third']) echo 'selected="selected"'; ?>>Lo último</option>
