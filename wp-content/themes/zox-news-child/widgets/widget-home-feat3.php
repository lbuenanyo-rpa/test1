...
add_action( 'widgets_init', 'mvp_home_feat2_load_widgets_custom' );

function mvp_home_feat2_load_widgets_custom() {
	register_widget( 'mvp_home_feat2_widget_custom' );
}

class mvp_home_feat2_widget_custom extends WP_Widget {
	...
	function __construct() {
		/* Widget settings. */
		$widget_ops = array( 'classname' => 'mvp_home_feat2_widget_custom', 'description' => esc_html__('Nuevo Widget con la Palabra More traducida 300x250 ad.', 'zox-news') );

		/* Widget control settings. */
		$control_ops = array( 'width' => 250, 'height' => 350, 'id_base' => 'mvp_home_feat2_widget_custom' );

		/* Create the widget. */
		parent::__construct( 'mvp_home_feat2_widget_custom', esc_html__('Zox News: Custom Home Featured 3 Widget', 'zox-news'), $widget_ops, $control_ops );
	}
					...
					<div class="mvp-widget-feat2-side left relative">
						<?php if ($code) { ?>
							<div class="mvp-widget-feat2-side-ad left relative">
								<span class="mvp-ad-label"><?php esc_html_e( 'Publicidad', 'zox-news' ); ?></span>
						...
						<div class="mvp-widget-feat2-side-list left relative">
							<div class="mvp-feat1-list left relative">
								<?php if ($tagcat == 'tag') { ?>
									...
									<?php endwhile; wp_reset_postdata(); ?>
								<?php } else { ?>
									<?php global $do_not_duplicate; global $post; if($code) { $mvp_post_num = 3; } else { $mvp_post_num = 5; }; $recent = new WP_Query(array( 'category_name' => $enterslug, 'posts_per_page' => $mvp_post_num, 'post__not_in'=>$do_not_duplicate, 'ignore_sticky_posts'=> 1 )); while($recent->have_posts()) : $recent->the_post(); ?>
										<a href="<?php the_permalink(); ?>" rel="bookmark">
										<div class="mvp-feat1-list-cont left relative">
											<?php if (  (function_exists('has_post_thumbnail')) && (has_post_thumbnail())  ) { ?>
												<div class="mvp-feat1-list-out relative">
							...
							<?php if ($tagcat == 'tag') { ?>
								...
								<div class="mvp-widget-feat2-side-more-but left relative">
									<span class="mvp-widget-feat2-side-more"><?php esc_html_e( 'Ver más', 'zox-news' ); ?> <?php echo esc_html( $title ); ?></span><i class="fa fa-long-arrow-right" aria-hidden="true"></i>
