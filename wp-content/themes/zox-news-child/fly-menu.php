<div id="mvp-fly-wrap">
		...
		<div class="mvp-fly-top-out left relative">
			<div class="mvp-fly-top-in">
				<div id="mvp-fly-logo" class="left relative">
					...
					<?php } else { ?>
						<a href="<?php echo esc_url( home_url( '/' ) ); ?>"><img src="<?php echo get_template_directory_uri(); ?>/images/logos/logo-nav-Que.png" alt="<?php bloginfo( 'name' ); ?>" data-rjs="2" /></a>
					<?php } ?>
				</div><!--mvp-fly-logo-->
			</div><!--mvp-fly-top-in-->
	...
	<div id="mvp-fly-soc-wrap">
		<span class="mvp-fly-soc-head"><?php esc_html_e( 'Síguenos en', 'zox-news' ); ?></span>
