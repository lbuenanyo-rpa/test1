												...
												<div class="mvp-nav-small-mid">
													<div class="mvp-nav-small-logo">
														<?php if(get_option('mvp_logo_nav')) { ?>
															<a href="<?php echo esc_url( home_url( '/' ) ); ?>"><amp-img src="<?php echo esc_url(get_option('mvp_logo_nav')); ?>" alt="<?php bloginfo( 'name' ); ?>" data-rjs="2" width="<?php echo esc_html(get_option('mvp_amp_logo')); ?>" height="37" layout="fixed"></amp-img></a>
														<?php } else { ?>
															<a href="<?php echo esc_url( home_url( '/' ) ); ?>"><amp-img src="<?php echo get_template_directory_uri(); ?>/images/logos/logo-nav-Que.png" alt="<?php bloginfo( 'name' ); ?>" data-rjs="2" width="<?php echo esc_html(get_option('mvp_amp_logo')); ?>" height="37" layout="fixed"></amp-img></a>
														<?php } ?>
													...
													<div class="mvp-author-info-wrap left relative">
														...
														<div class="mvp-author-info-text left relative">
															<div class="mvp-author-info-date left relative">
																<p><?php esc_html_e( 'Publicado', 'zox-news' ); ?></p> <span class="mvp-post-date"><?php printf( esc_html__( 'hace %s', 'zox-news' ), human_time_diff( get_the_time( 'U' ), current_time( 'timestamp' ) ) ); ?></span> <p><?php esc_html_e( 'el', 'zox-news' ); ?></p> <span class="mvp-post-date updated"><time class="post-date updated" itemprop="datePublished" datetime="<?php the_time('Y-m-d'); ?>"><?php the_time(get_option('date_format')); ?></time></span>
																<meta itemprop="dateModified" content="<?php the_modified_date('Y-m-d g:i a'); ?>"/>
															</div><!--mvp-author-info-date-->
															<div class="mvp-author-info-name left relative" itemprop="author" itemscope itemtype="https://schema.org/Person">
																<p><?php esc_html_e( 'Por', 'zox-news' ); ?></p> <span class="author-name vcard fn author" itemprop="name"><?php the_author_posts_link(); ?></span> <?php $authortwit = get_the_author_meta('twitter'); if ( ! empty ( $authortwit ) ) { ?><a href="<?php echo esc_url(the_author_meta('twitter')); ?>" class="mvp-twit-but" target="_blank"><span class="mvp-author-info-twit-but"><i class="fa fa-twitter fa-2"></i></span></a><?php } ?>
																	...
																	<div id="mvp-content-body-top" class="left relative">
																		...
																		<div id="mvp-content-bot" class="left">
																			<div class="mvp-post-tags">
																				<span class="mvp-post-tags-header"><?php esc_html_e( 'Tópicos:', 'zox-news' ); ?></span><span itemprop="keywords"><?php the_tags('','','') ?></span>
																		</div><!--mvp-post-tags-->
																		<div class="mvp-org-wrap" itemprop="publisher" itemscope itemtype="https://schema.org/Organization">
																			<div class="mvp-org-logo" itemprop="logo" itemscope itemtype="https://schema.org/ImageObject">
																				<?php if(get_option('mvp_logo_nav')) { ?>
																					<amp-img src="<?php echo esc_url(get_option('mvp_logo_nav')); ?>" alt="<?php bloginfo( 'name' ); ?>" data-rjs="2" width="<?php echo esc_html(get_option('mvp_amp_logo')); ?>" height="37" layout="fixed"></amp-img>
																					<meta itemprop="url" content="<?php echo esc_url(get_option('mvp_logo_nav')); ?>">
																				<?php } else { ?>
																					<amp-img src="<?php echo get_template_directory_uri(); ?>/images/logos/logo-nav-Que.png" alt="<?php bloginfo( 'name' ); ?>" data-rjs="2" width="<?php echo esc_html(get_option('mvp_amp_logo')); ?>" height="37" layout="fixed"></amp-img>
																					<meta itemprop="url" content="<?php echo get_template_directory_uri(); ?>/images/logos/logo-nav-Que.png">
																				<?php } ?>
																			</div><!--mvp-org-logo-->
													...
													<li>
														...
														<div class="mvp-post-more-text left relative">
															...
															<div class="mvp-cat-date-wrap left relative">
																<span class="mvp-cd-cat left relative"><?php $category = get_the_category(); echo esc_html( $category[0]->cat_name ); ?></span><span class="mvp-cd-date left relative"><?php printf( esc_html__( 'hace %s', 'zox-news' ), human_time_diff( get_the_time( 'U' ), current_time( 'timestamp' ) ) ); ?></span>
